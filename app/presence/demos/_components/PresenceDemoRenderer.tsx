...
import DemoGalleryClient from "../[slug]/_components/DemoGalleryClient";
import { getPresenceDemo } from "@/src/lib/presence-demo/templates";

type PresenceDemoRendererProps = {
  slug: string;
};

export default function PresenceDemoRenderer(props: PresenceDemoRendererProps) {
